...
def test_jacobian():
    ...
    # import timeit
    #
    # x_shape, a_shape = (1, 100), (100, 40)
    # x_shape, a_shape = (1, 10), (10, 40)
    # x_shape, a_shape = (1, 3), (3, 4)
    #
    # def old():
    ...
    #
    # num = 5
    # old = timeit.timeit(lambda: old(), number=num)
    # new = timeit.timeit(lambda: new(), number=num)
    # print(f'old: {old}\nnew: {new}\nfactor: {old / new if new < old else new / old}')
