...
def test_loss_cce():
    ...
    def single_point_loss_uneven_target():
        y_predicted = np.array([0.05, 0.95, 0], dtype='float64')
        y_target = np.array([0.2, 0.2, 0.2], dtype='float64')
        target = np.array([3.8330242437799726], dtype='float64')
        value = loss(y_predicted=y_predicted, y_target=y_target)
    ...
    def multi_point_loss_uneven_target():
        y_predicted = np.array([[0.05, 0.95, 0], [0.1, 0.8, 0.1]], dtype='float64')
        y_target = np.array([[0.2, 0.2, 0.2], [0.1, 0.1, 0.1]], dtype='float64')
        target = np.array([2.1579278087551015], dtype='float64')
        value = loss(y_predicted=y_predicted, y_target=y_target)
    ...
    single_point_loss()
    single_point_loss_uneven_target()
    multi_point_loss()
    multi_point_loss_uneven_target()
